...
namespace SeleneGame.UI {
    ...
    public class CharacterCostumeSelectionMenuController : UIMenu<CharacterCostumeSelectionMenuController> {
        ...
        private Character.Instance currentCharacter;
        ...
        public void ReplaceCharacterCostume(Character.Instance character) {
        ...
        private void GetEquippableCostumes() {
            ...
            CharacterCostume.GetBaseAsync( currentCharacter.name, (defaultCostume) => {

                    // Get the Default Costume (corresponds to an empty slot, should be in the first space)
                    CreateCharacterCostumeCase(defaultCostume);
                    ResetGamePadSelection();

                    // and then get all the other costumes.
                    CharacterCostume.GetCostumesFor(currentCharacter.character, (costume) => {
