...
namespace SeleneGame {
    ...
    public class ShiftingState : State{
        ...
        public override bool shifting => true;
        ...
        public override void HandleInput(){
            ...
            if (entity.isPlayer){
                Vector3 newfallTurn = new Vector3(entity.currentFrameMoveInput.x, 0, entity.currentFrameMoveInput.z);
        ...
        private void OnEvadeInputStart(float timer){
            entity.inertiaDirection = entity.currentFrameLookRotation * Vector3.forward;
            // entity.Evade();
        }
