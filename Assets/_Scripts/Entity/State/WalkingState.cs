...
namespace SeleneGame {
    ...
    public class WalkingState : State{
        ...
        public override bool shifting => Vector3.Dot ( entity.gravityDown, Vector3.down ) < 0.95f || entity.inWater || entity.currentWeapon.shifting;
        ...
        public override void StateFixedUpdate(){
            ...
            if ( (entity.evadeTimer > entity.data.evadeCooldown + entity.data.evadeDuration - 0.2f || !entity.evading) && entity.moveDirection.magnitude > 0f){
