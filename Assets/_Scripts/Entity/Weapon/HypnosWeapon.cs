...
namespace SeleneGame {
    ...
    public class HypnosWeapon : Weapon{
        ...
        protected override Vector3 GetCameraPosition(){
            if (wallRun && Vector3.Dot( -entity.wallHit.normal, entity._t.right ) > 0.75f)
        ...
        private ExtendedBool wallRunData = new ExtendedBool();
        ...
        protected override void UpdateEquipped(){
            ...
            wallRunData.Update(entity.sliding && wallStand);
