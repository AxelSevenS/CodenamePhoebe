    ...
    public class Player : MonoBehaviour{
        ...
        private void ObjectManipulation(){
            ...
            if ( entity.focusing ){
                ...
                foreach ( Collider hit in Physics.OverlapSphere(entity._t.position, 15f, Global.ObjectEntityMask) ){
        ...
        private void ObjectInteraction(){
            if ( !menu && !talking && !entity.walkingTo ){
                ...
                if (entity.currentState is SittingState){
                    ...
                    foreach ( Collider hit in Physics.OverlapSphere(entity._t.position, 5f, Global.ObjectEntityMask) ){

                        Vector3 vectorToObject = (hit.transform.position - entity._t.position);
